...
export interface components {
  schemas: {
    ...
    /** @enum {string} */
    approvalv2ApprovalSetStatus: "PENDING" | "MET" | "NOT_MET" | "EXPIRED" | "FAILED"
    /** @enum {string} */
    ...
    /** @enum {string} */
    identityv1ApprovalSetStatus: "PENDING" | "MET" | "NOT_MET" | "EXPIRED" | "FAILED"
    /** @enum {string} */
    ...
    /** @enum {string} */
    identityv1WalletStatus: "CREATED" | "PROVISIONING" | "PROVISIONED" | "PROVISIONING_FAILED"
    protobufAny: {
      "@type"?: string
    } & {
      [key: string]: unknown
    ...
    /** @enum {string} */
    transactionsv2AddressType: "COUNTERPARTY" | "WALLET" | "EXTERNAL" | "ALLOW_ADDRESS"
    transactionsv2Asset: {
      /**
    ...
    /** @enum {string} */
    transactionsv2OfferCreateFlags: "PASSIVE" | "IMMEDIATE_OR_CANCEL" | "FILL_OR_KILL" | "SELL"
    ...
    /** @enum {string} */
    v2BlockchainStatus: "RPC_ENDPOINT_TYPE_ENABLED" | "RPC_ENDPOINT_TYPE_DISABLED"
    v2BoolFilter: {
      /** @description Equals */
      eq?: boolean
    ...
    /** @enum {string} */
    v2QuorumType: "QUORUM_TYPE_MOBILE" | "QUORUM_TYPE_CLOUD" | "QUORUM_TYPE_MIXED"
    v2RPCEndpoint: {
      /**
    ...
    /** @enum {string} */
    v2Role: "ADMINISTRATOR" | "APPROVER" | "AUDITOR" | "OWNER" | "PROPOSER" | "VIEWER"
    v2S3Config: {
    ...
    v2SourceType:
      ...
      | "ADDRESS"
    /** @enum {string} */
    v2Standard: "NATIVE" | "ERC20" | "ISSUED_CURRENCY" | "ERC721" | "SPL" | "CUSTOM"
    v2StringFilter: {
    ...
    /** @enum {string} */
    xrpv2OfferCreateFlags: "PASSIVE" | "IMMEDIATE_OR_CANCEL" | "FILL_OR_KILL" | "SELL"
    xrpv2SignerEntry: {
      account?: string
      /** Format: int64 */
      signerWeight?: number
